...
def main(input_filepath: str, output_filepath: str):
    ...
    for text in tqdm(test_data['comment_text'], desc="Tokenizing Test Data"):
        test_tokens.append(
            tokenizer.encode_plus(text, truncation=True, max_length=64, padding="max_length", return_tensors="pt"))
    train_tokens = []
    ...
    labels_test_split, labels_val_split = torch.split(labels_test, labels_test.size(0) // 2, dim=0)
