...
*s202192, s133696, s103121, s215917*
...
We have developped two docker images for our project: one for training the model ([TrainerLocal.dockerfile](https://github.com/dhsvendsen/MLOps-Project-Detox/blob/main/TrainerLocal.dockerfile)) and a second for deploying the model to a FastApi ([Simple_app.dockerfile](https://github.com/dhsvendsen/MLOps-Project-Detox/blob/main/simple_app.dockerfile)).
